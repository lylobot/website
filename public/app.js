const translations = {
  es: {
    ...
    statTracking: 'Seguimiento de comunidad',
  ...
  en: {
    ...
    statTracking: 'Community monitoring',
...
async function loadSession() {
  ...
  document.querySelector('[data-connected]')?.classList.toggle('hidden', !data.authenticated);
  if (data.authenticated && data.user) {
    ...
    profile.append(avatar, name); profile.title = data.user.username;
      ...
      const footerProfile = document.querySelector('[data-footer-profile]');
      if (footerAccount && footerProfile) {
        footerProfile.append(avatar.cloneNode(true), name.cloneNode(true));
        footerProfile.title = data.user.username;
        footerAccount.classList.remove('hidden');
        document.querySelector('[data-footer-panel]')?.classList.remove('hidden');
