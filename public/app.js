...
async function loadSession() {
  ...
  if (data.authenticated && data.user) {
    ...
    if (sidebarProfile) { sidebarProfile.innerHTML = ''; sidebarProfile.append(avatar.cloneNode(true), name.cloneNode(true)); sidebarProfile.title = data.user.username; sidebarProfile.classList.remove('hidden'); }
    document.querySelector('.panel-sidebar-link')?.classList.remove('hidden');
  }
}
